...
function step() {
  setTimeout(function () {
    if (n < string.length) {
      ...
      divHtml.innerHTML = s2; // html.innerHTML =string.substring(0,n+1) ;

      style.innerHTML = string.substring(0, n + 1);
      window.scrollTo(0, 99999);
      divHtml.scroll(0, 99999);
      n = n + 1;
      step();
    }
  }, 50);
